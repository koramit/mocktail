...
use App\Http\Controllers\ExportAdmitOrderController;
...
Route::middleware('auth', 'can:export_hi_dos')->get('/reports/refer-cases-admit-order', ExportAdmitOrderController::class);
